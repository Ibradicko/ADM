...
/**
 * Criteria class for the {@link com.adm.supervision.domain.DepotStock} entity. This class is used
 * in {@link com.adm.supervision.web.rest.DepotStockResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /depot-stocks?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DepotStockCriteria implements Serializable, Criteria {
    ...
    public DepotStockCriteria() {}

    public DepotStockCriteria(DepotStockCriteria other) {
    ...
    @Override
    public DepotStockCriteria copy() {
        return new DepotStockCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DepotStockCriteria that = (DepotStockCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, libelle, emplacement, actif, boutiqueId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "DepotStockCriteria{" +
