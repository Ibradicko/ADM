...
/**
 * Criteria class for the {@link com.adm.supervision.domain.ProfilMetier} entity. This class is used
 * in {@link com.adm.supervision.web.rest.ProfilMetierResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /profil-metiers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProfilMetierCriteria implements Serializable, Criteria {
    ...
    public ProfilMetierCriteria() {}

    public ProfilMetierCriteria(ProfilMetierCriteria other) {
    ...
    @Override
    public ProfilMetierCriteria copy() {
        return new ProfilMetierCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProfilMetierCriteria that = (ProfilMetierCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, libelle, statut, permissionsId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ProfilMetierCriteria{" +
