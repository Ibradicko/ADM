...
/**
 * Criteria class for the {@link com.adm.supervision.domain.SousFamilleArticle} entity. This class is used
 * in {@link com.adm.supervision.web.rest.SousFamilleArticleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sous-famille-articles?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SousFamilleArticleCriteria implements Serializable, Criteria {
    ...
    public SousFamilleArticleCriteria() {}

    public SousFamilleArticleCriteria(SousFamilleArticleCriteria other) {
    ...
    @Override
    public SousFamilleArticleCriteria copy() {
        return new SousFamilleArticleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SousFamilleArticleCriteria that = (SousFamilleArticleCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, libelle, statut, familleArticleId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "SousFamilleArticleCriteria{" +
