...
import { AffectationUtilisateurDeleteDialog } from './affectation-utilisateur-delete-dialog';

describe('AffectationUtilisateur Management Delete Component', () => {
  let comp: AffectationUtilisateurDeleteDialog;
  let fixture: ComponentFixture<AffectationUtilisateurDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AffectationUtilisateurDeleteDialog);
