...
describe('AffectationUtilisateur routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IAffectationUtilisateur returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(affectationUtilisateurResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
