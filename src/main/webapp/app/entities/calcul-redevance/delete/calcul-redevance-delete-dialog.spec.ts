...
import { CalculRedevanceDeleteDialog } from './calcul-redevance-delete-dialog';

describe('CalculRedevance Management Delete Component', () => {
  let comp: CalculRedevanceDeleteDialog;
  let fixture: ComponentFixture<CalculRedevanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CalculRedevanceDeleteDialog);
