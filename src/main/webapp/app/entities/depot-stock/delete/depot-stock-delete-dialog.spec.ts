...
import { DepotStockDeleteDialog } from './depot-stock-delete-dialog';

describe('DepotStock Management Delete Component', () => {
  let comp: DepotStockDeleteDialog;
  let fixture: ComponentFixture<DepotStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DepotStockDeleteDialog);
