...
import { EtiquetteProduitDeleteDialog } from './etiquette-produit-delete-dialog';

describe('EtiquetteProduit Management Delete Component', () => {
  let comp: EtiquetteProduitDeleteDialog;
  let fixture: ComponentFixture<EtiquetteProduitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EtiquetteProduitDeleteDialog);
