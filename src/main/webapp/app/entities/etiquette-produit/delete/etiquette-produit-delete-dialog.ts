...
@Component({
  templateUrl: './etiquette-produit-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class EtiquetteProduitDeleteDialog {
  etiquetteProduit?: IEtiquetteProduit;
  ...
  confirmDelete(id: number): void {
    this.etiquetteProduitService.delete(id).subscribe(() => {
