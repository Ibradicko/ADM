...
import { FamilleArticleDeleteDialog } from './famille-article-delete-dialog';

describe('FamilleArticle Management Delete Component', () => {
  let comp: FamilleArticleDeleteDialog;
  let fixture: ComponentFixture<FamilleArticleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FamilleArticleDeleteDialog);
