...
import { GroupeArticleDeleteDialog } from './groupe-article-delete-dialog';

describe('GroupeArticle Management Delete Component', () => {
  let comp: GroupeArticleDeleteDialog;
  let fixture: ComponentFixture<GroupeArticleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GroupeArticleDeleteDialog);
