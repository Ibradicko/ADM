...
import { HistoriqueCodeBarresDeleteDialog } from './historique-code-barres-delete-dialog';

describe('HistoriqueCodeBarres Management Delete Component', () => {
  let comp: HistoriqueCodeBarresDeleteDialog;
  let fixture: ComponentFixture<HistoriqueCodeBarresDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(HistoriqueCodeBarresDeleteDialog);
