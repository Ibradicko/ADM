...
@Component({
  templateUrl: './historique-code-barres-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class HistoriqueCodeBarresDeleteDialog {
  historiqueCodeBarres?: IHistoriqueCodeBarres;
  ...
  confirmDelete(id: number): void {
    this.historiqueCodeBarresService.delete(id).subscribe(() => {
