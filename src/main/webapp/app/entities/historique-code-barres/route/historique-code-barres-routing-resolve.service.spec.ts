...
import historiqueCodeBarresResolve from './historique-code-barres-routing-resolve.service';

describe('HistoriqueCodeBarres routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IHistoriqueCodeBarres returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          historiqueCodeBarresResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(historiqueCodeBarresResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
