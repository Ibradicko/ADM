...
import { InventaireStockDeleteDialog } from './inventaire-stock-delete-dialog';

describe('InventaireStock Management Delete Component', () => {
  let comp: InventaireStockDeleteDialog;
  let fixture: ComponentFixture<InventaireStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(InventaireStockDeleteDialog);
