...
import { LigneCalculRedevanceDeleteDialog } from './ligne-calcul-redevance-delete-dialog';

describe('LigneCalculRedevance Management Delete Component', () => {
  let comp: LigneCalculRedevanceDeleteDialog;
  let fixture: ComponentFixture<LigneCalculRedevanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneCalculRedevanceDeleteDialog);
