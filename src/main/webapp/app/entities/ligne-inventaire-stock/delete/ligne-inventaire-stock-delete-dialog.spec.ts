...
import { LigneInventaireStockDeleteDialog } from './ligne-inventaire-stock-delete-dialog';

describe('LigneInventaireStock Management Delete Component', () => {
  let comp: LigneInventaireStockDeleteDialog;
  let fixture: ComponentFixture<LigneInventaireStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneInventaireStockDeleteDialog);
