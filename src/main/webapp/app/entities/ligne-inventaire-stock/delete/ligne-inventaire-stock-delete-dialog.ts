...
@Component({
  templateUrl: './ligne-inventaire-stock-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class LigneInventaireStockDeleteDialog {
  ligneInventaireStock?: ILigneInventaireStock;
  ...
  confirmDelete(id: number): void {
    this.ligneInventaireStockService.delete(id).subscribe(() => {
