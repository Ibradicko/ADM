...
import ligneInventaireStockResolve from './ligne-inventaire-stock-routing-resolve.service';

describe('LigneInventaireStock routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ILigneInventaireStock returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          ligneInventaireStockResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(ligneInventaireStockResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
