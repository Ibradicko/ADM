...
import { LigneMouvementStockDeleteDialog } from './ligne-mouvement-stock-delete-dialog';

describe('LigneMouvementStock Management Delete Component', () => {
  let comp: LigneMouvementStockDeleteDialog;
  let fixture: ComponentFixture<LigneMouvementStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneMouvementStockDeleteDialog);
