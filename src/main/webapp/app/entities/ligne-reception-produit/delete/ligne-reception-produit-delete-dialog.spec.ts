...
import { LigneReceptionProduitDeleteDialog } from './ligne-reception-produit-delete-dialog';

describe('LigneReceptionProduit Management Delete Component', () => {
  let comp: LigneReceptionProduitDeleteDialog;
  let fixture: ComponentFixture<LigneReceptionProduitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneReceptionProduitDeleteDialog);
