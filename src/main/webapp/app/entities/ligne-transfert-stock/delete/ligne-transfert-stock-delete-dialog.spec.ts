...
import { LigneTransfertStockDeleteDialog } from './ligne-transfert-stock-delete-dialog';

describe('LigneTransfertStock Management Delete Component', () => {
  let comp: LigneTransfertStockDeleteDialog;
  let fixture: ComponentFixture<LigneTransfertStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneTransfertStockDeleteDialog);
