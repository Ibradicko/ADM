...
@Component({
  templateUrl: './ligne-transfert-stock-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class LigneTransfertStockDeleteDialog {
  ligneTransfertStock?: ILigneTransfertStock;
  ...
  confirmDelete(id: number): void {
    this.ligneTransfertStockService.delete(id).subscribe(() => {
