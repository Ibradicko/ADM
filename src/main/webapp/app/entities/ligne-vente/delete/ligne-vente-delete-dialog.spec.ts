...
import { LigneVenteDeleteDialog } from './ligne-vente-delete-dialog';

describe('LigneVente Management Delete Component', () => {
  let comp: LigneVenteDeleteDialog;
  let fixture: ComponentFixture<LigneVenteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LigneVenteDeleteDialog);
