...
import { LocataireDeleteDialog } from './locataire-delete-dialog';

describe('Locataire Management Delete Component', () => {
  let comp: LocataireDeleteDialog;
  let fixture: ComponentFixture<LocataireDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LocataireDeleteDialog);
