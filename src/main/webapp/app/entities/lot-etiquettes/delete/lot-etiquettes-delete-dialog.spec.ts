...
import { LotEtiquettesDeleteDialog } from './lot-etiquettes-delete-dialog';

describe('LotEtiquettes Management Delete Component', () => {
  let comp: LotEtiquettesDeleteDialog;
  let fixture: ComponentFixture<LotEtiquettesDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LotEtiquettesDeleteDialog);
