...
import { ModePaiementRefDeleteDialog } from './mode-paiement-ref-delete-dialog';

describe('ModePaiementRef Management Delete Component', () => {
  let comp: ModePaiementRefDeleteDialog;
  let fixture: ComponentFixture<ModePaiementRefDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ModePaiementRefDeleteDialog);
