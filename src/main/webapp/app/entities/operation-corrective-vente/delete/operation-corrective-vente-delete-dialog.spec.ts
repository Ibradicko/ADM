...
import { OperationCorrectiveVenteDeleteDialog } from './operation-corrective-vente-delete-dialog';

describe('OperationCorrectiveVente Management Delete Component', () => {
  let comp: OperationCorrectiveVenteDeleteDialog;
  let fixture: ComponentFixture<OperationCorrectiveVenteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OperationCorrectiveVenteDeleteDialog);
