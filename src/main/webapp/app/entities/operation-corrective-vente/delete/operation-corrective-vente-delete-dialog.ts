...
@Component({
  templateUrl: './operation-corrective-vente-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class OperationCorrectiveVenteDeleteDialog {
  operationCorrectiveVente?: IOperationCorrectiveVente;
  ...
  confirmDelete(id: number): void {
    this.operationCorrectiveVenteService.delete(id).subscribe(() => {
