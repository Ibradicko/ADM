...
import operationCorrectiveVenteResolve from './operation-corrective-vente-routing-resolve.service';

describe('OperationCorrectiveVente routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IOperationCorrectiveVente returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          operationCorrectiveVenteResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(operationCorrectiveVenteResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
