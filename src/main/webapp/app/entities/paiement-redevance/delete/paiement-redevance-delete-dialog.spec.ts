...
import { PaiementRedevanceDeleteDialog } from './paiement-redevance-delete-dialog';

describe('PaiementRedevance Management Delete Component', () => {
  let comp: PaiementRedevanceDeleteDialog;
  let fixture: ComponentFixture<PaiementRedevanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PaiementRedevanceDeleteDialog);
