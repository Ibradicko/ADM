...
@Component({
  templateUrl: './parametre-code-barres-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class ParametreCodeBarresDeleteDialog {
  parametreCodeBarres?: IParametreCodeBarres;
  ...
  confirmDelete(id: number): void {
    this.parametreCodeBarresService.delete(id).subscribe(() => {
