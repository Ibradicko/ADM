...
import { PermissionMetierDeleteDialog } from './permission-metier-delete-dialog';

describe('PermissionMetier Management Delete Component', () => {
  let comp: PermissionMetierDeleteDialog;
  let fixture: ComponentFixture<PermissionMetierDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PermissionMetierDeleteDialog);
