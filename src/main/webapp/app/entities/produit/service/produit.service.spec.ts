...
describe('Produit Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Produit', () => {
      ...
      service.create(produit).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Produit', () => {
      ...
      service.update(produit).subscribe(resp => (expectedResult = resp));
    ...
    describe('addProduitToCollectionIfMissing', () => {
      it('should add a Produit to an empty array', () => {
        ...
        expect(expectedResult).toEqual([produit]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([produit, produit2]);
      });
