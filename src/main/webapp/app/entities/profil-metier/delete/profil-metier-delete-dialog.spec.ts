...
import { ProfilMetierDeleteDialog } from './profil-metier-delete-dialog';

describe('ProfilMetier Management Delete Component', () => {
  let comp: ProfilMetierDeleteDialog;
  let fixture: ComponentFixture<ProfilMetierDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProfilMetierDeleteDialog);
