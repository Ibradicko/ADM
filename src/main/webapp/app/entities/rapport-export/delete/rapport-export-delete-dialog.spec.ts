...
import { RapportExportDeleteDialog } from './rapport-export-delete-dialog';

describe('RapportExport Management Delete Component', () => {
  let comp: RapportExportDeleteDialog;
  let fixture: ComponentFixture<RapportExportDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RapportExportDeleteDialog);
