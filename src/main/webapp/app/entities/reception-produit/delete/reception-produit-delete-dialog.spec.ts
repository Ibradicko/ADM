...
import { ReceptionProduitDeleteDialog } from './reception-produit-delete-dialog';

describe('ReceptionProduit Management Delete Component', () => {
  let comp: ReceptionProduitDeleteDialog;
  let fixture: ComponentFixture<ReceptionProduitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ReceptionProduitDeleteDialog);
