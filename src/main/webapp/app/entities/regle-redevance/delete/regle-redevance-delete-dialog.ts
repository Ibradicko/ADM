...
@Component({
  templateUrl: './regle-redevance-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class RegleRedevanceDeleteDialog {
  regleRedevance?: IRegleRedevance;
  ...
  confirmDelete(id: number): void {
    this.regleRedevanceService.delete(id).subscribe(() => {
