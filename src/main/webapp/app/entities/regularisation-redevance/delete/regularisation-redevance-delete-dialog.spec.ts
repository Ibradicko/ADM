...
import { RegularisationRedevanceDeleteDialog } from './regularisation-redevance-delete-dialog';

describe('RegularisationRedevance Management Delete Component', () => {
  let comp: RegularisationRedevanceDeleteDialog;
  let fixture: ComponentFixture<RegularisationRedevanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RegularisationRedevanceDeleteDialog);
