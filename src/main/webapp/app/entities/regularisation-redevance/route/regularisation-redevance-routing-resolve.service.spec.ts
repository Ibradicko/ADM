...
import regularisationRedevanceResolve from './regularisation-redevance-routing-resolve.service';

describe('RegularisationRedevance routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IRegularisationRedevance returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          regularisationRedevanceResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(regularisationRedevanceResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
