...
import { SousFamilleArticleDeleteDialog } from './sous-famille-article-delete-dialog';

describe('SousFamilleArticle Management Delete Component', () => {
  let comp: SousFamilleArticleDeleteDialog;
  let fixture: ComponentFixture<SousFamilleArticleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SousFamilleArticleDeleteDialog);
