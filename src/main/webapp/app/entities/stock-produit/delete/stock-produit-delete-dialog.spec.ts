...
import { StockProduitDeleteDialog } from './stock-produit-delete-dialog';

describe('StockProduit Management Delete Component', () => {
  let comp: StockProduitDeleteDialog;
  let fixture: ComponentFixture<StockProduitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StockProduitDeleteDialog);
