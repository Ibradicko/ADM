...
import { TarifProduitDeleteDialog } from './tarif-produit-delete-dialog';

describe('TarifProduit Management Delete Component', () => {
  let comp: TarifProduitDeleteDialog;
  let fixture: ComponentFixture<TarifProduitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TarifProduitDeleteDialog);
