...
import { TicketCaisseDeleteDialog } from './ticket-caisse-delete-dialog';

describe('TicketCaisse Management Delete Component', () => {
  let comp: TicketCaisseDeleteDialog;
  let fixture: ComponentFixture<TicketCaisseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TicketCaisseDeleteDialog);
