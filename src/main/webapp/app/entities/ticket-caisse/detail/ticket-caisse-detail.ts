...
@Component({
  selector: 'jhi-ticket-caisse-detail',
  templateUrl: './ticket-caisse-detail.html',
  imports: [FontAwesomeModule, Alert, AlertError, TranslateDirective, TranslateModule, RouterLink, FormatMediumDatetimePipe],
})
export class TicketCaisseDetail {
  readonly ticketCaisse = input<ITicketCaisse | null>(null);
