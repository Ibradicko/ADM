...
import { TransfertStockDeleteDialog } from './transfert-stock-delete-dialog';

describe('TransfertStock Management Delete Component', () => {
  let comp: TransfertStockDeleteDialog;
  let fixture: ComponentFixture<TransfertStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TransfertStockDeleteDialog);
