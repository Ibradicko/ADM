...
import { UniteMesureDeleteDialog } from './unite-mesure-delete-dialog';

describe('UniteMesure Management Delete Component', () => {
  let comp: UniteMesureDeleteDialog;
  let fixture: ComponentFixture<UniteMesureDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UniteMesureDeleteDialog);
